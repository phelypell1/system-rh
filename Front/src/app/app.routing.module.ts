import { funcionarios } from './core/models/funcionarios.model';
...
const appRoutes: Routes = [
    ...
    },
    {
        ...
        {
          path: 'funcionarios',
          loadChildren: () => import('src/app/features/funcionarios/funcionarios.module').then(m => m.FuncionariosModule),
          canActivate: [AuthGuard]
        },
        {
            path: 'employees',
